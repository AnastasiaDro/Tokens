...
- Ориентацией централизованно управляет app: экран жетонов на небольшом полноэкранном устройстве фиксируется в landscape, диалоги наследуют режим базового экрана, а настройки, большие экраны и многооконный режим используют системную ориентацию. При изменениях навигации проверять сохранение destination/back stack, включая диалоги.
