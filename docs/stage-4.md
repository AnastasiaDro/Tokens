...
1. **4.6. Адаптивность и 20.** Одновременно изменить UI, рабочие ограничения и валидацию сохранений. Историческую нормализацию SharedPreferences не расширять автоматически. Снять ограничение landscape только после проверки всех доступных экранов, включая старое фото.
2. **4.7. Очистка.** Удалить заменённый UI и зависимости без потребителей, обновить правила, провести финальные JVM/instrumentation/debug-проверки.
